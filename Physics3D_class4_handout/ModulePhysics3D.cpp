...
{
	btVector3 anchorA2(anchorA.x, anchorA.y, anchorA.z);
	btVector3 anchorB2(anchorB.x, anchorB.y, anchorB.z);
	btPoint2PointConstraint* constraint = new btPoint2PointConstraint(*bodyA.body, *bodyB.body, anchorA2, anchorB2);
